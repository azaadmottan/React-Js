...
function PostForm({ post }) {
    ...
    return (
    <>
    <div className='w-8/12 m-auto my-6 px-6 py-8 bg-zinc-200 bg-opacity-70 rounded-lg'>
        ...
        <div className='bg-white flex flex-wrap max-w-[100%] items-center justify-between px-12 py-8 mt-8 rounded-xl'>
                ...
                <div className='w-[48%]'>
                    <div>
                        <input type="text" 
                            ...
                            className='w-full text-3xl text-zinc-800 font-medium outline-none  border-b-2 border-b-zinc-400' 
                    ...
                    <div className='mt-8'>
                        <input type="text" 
                            ...
                            className='w-full text-lg text-zinc-800 font-medium outline-none border-b-2 border-b-zinc-400'
                            {...register("content", { required: true })}
                        />
                    </div>

                    <div className='mt-8'>
                        <label htmlFor="status" className='inline-block text-lg mb-3 font-medium'>Select Status</label>
                        <select 
