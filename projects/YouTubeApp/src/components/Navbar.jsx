...
import { clearVideos, changeSearchTerm } from "../youTubeSlicer/youTubeSlicer";
...
function Navbar() {
  ...
  return (
    <>
      <div
        className="w-full bg-zinc-800 text-white px-6 py-0
      ...
      >
        <div className="flex gap-1 items-center">
          ...
          <img
            src="https://www.gstatic.com/youtube/img/promos/growth/e1e3e9c1165e3a68a636e81cc6cef3477468427ab1d498f355d47e787ba3b90c_122x56.webp"
            alt="YouTube"
          />
          {/* <svg xmlns="http://www.w3.org/2000/svg" class="external-icon" viewBox="0 0 90 20" focusable="false" style={{"pointer-events": "none", "display": "block", "width": "100%", "height": "50%",}}>
        ...
        <div className="w-5/12 flex items-center gap-4">
          <form className="w-full" onSubmit={(e) => {e.preventDefault();handleSearch()}}>
            <div className="flex items-center justify-between bg-zinc-800  border-[0.2px] border-opacity-15 border-gray-50 rounded-3xl">
              <div className="w-full">
                <input
                  ...
                  placeholder="Search"
                  className="w-full focus:outline-none border-none bg-zinc-800 px-4 py-1 rounded-l-3xl"
                />
              </div>
              <div className="w-[60px] h-[35px] flex items-center bg-zinc-700 rounded-r-3xl hover:bg-zinc-600">
          ...
          <button>
            <MdKeyboardVoice className="text-2xl w-[35px] h-[35px] py-1 bg-zinc-700 rounded-full hover:bg-zinc-600" />
          </button>
        </div>

        <div className="flex items-center gap-4">
          <button>
            <MdOutlineVideoCall className="text-2xl w-[35px] h-[35px] py-1 hover:bg-zinc-700 rounded-full" />
          </button>
          <button>
            <IoMdNotificationsOutline className="text-2xl w-[35px] h-[35px] py-1 hover:bg-zinc-700 rounded-full relative" />
            <span className="absolute top-2 bg-red-600 px-1 text-xs rounded-lg text-white">
              6+
            </span>
          </button>
          <button>
            <CgProfile className="text-2xl w-[35px] h-[35px] py-1 hover:bg-zinc-700 rounded-full" />
          </button>
        </div>
      </div>
    </>
